...
export default function FlagSeverityAddPanel ({toggleReload}) {
  ...
  */
  ...
  const handleSubmit = (e) => {
    ...
    setLoading(true)
    let input = `/api/set_flag_severity`;
    input += `?name=${name}`;
  ...
  return (
    <div>
        <Button variant="contained" onClick={handleClickOpen}>Add Flag Severity</Button>
      <Dialog open={open} onClose={handleClose}>
        <DialogTitle>Add Flag Severity</DialogTitle>
        <DialogContent>
          <TextField
            autoFocus
            margin="dense"
